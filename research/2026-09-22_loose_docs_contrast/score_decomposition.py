"""Score decomposition, loose-docs contrast: baseline formula, 3-doc corpus.

NOTE (context): v1 decomposition script logic UNCHANGED from
research/2026-09-22_alias_boost_ablation/score_decomposition.py, run
against the regenerated 3-doc metadata/chunks.json (see run_ablation.py
docstring in this directory). chunks.json is restored afterward.
